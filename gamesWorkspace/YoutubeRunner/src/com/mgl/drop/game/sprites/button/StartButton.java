	...
	public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
		...
		try {
			...
			case TouchEvent.ACTION_DOWN:
				 ...
				 * (),scene,level,false,true);
				 * powerBar.setSize(MainDropActivity.CAMERA_WIDTH, 150);
				 * //powerBar.setPosition(MainDropActivity.CAMERA_WIDTH -
				 * powerBar.getWidth(), 60);
				 * powerBar.setPosition(MainDropActivity.CAMERA_WIDTH/2
				 * -powerBar.getWidth()/2, MainDropActivity.CAMERA_HEIGHT -
				 * powerBar.getHeight() -3); powerBar.setAlpha(0.8f);
				 * //HUDManagerSingleton
				 * .getInstance().getTop().attachChild(powerBar);
				 */
