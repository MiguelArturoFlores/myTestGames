...
public class EquipHUD extends MyHud {
	...
	public EquipHUD() {
		...
		try {
			...
			hand.setItem(MyFactory.createItem(PlayerSingleton.getInstance().getPlayer().getHand()));
			ear.setItem(MyFactory.createItem(PlayerSingleton.getInstance().getPlayer().getEaring()));
			sock.setItem(MyFactory.createItem(PlayerSingleton.getInstance().getPlayer().getSock()));
	...
	private void addStatusBars() {
		try {
			...
			String str = "STR/"
					+ PlayerSingleton.getInstance().getPlayer().getStrength();
			...
			str = PlayerSingleton.getInstance().getPlayer().getStrengthExtra() >= 0 ? " + "
					: " ";
			str = str
			...
			if (PlayerSingleton.getInstance().getPlayer().getStrengthExtra() >= 0) {
			...
			// =============================dexterity========================================
			str = "DEX/"
					+ PlayerSingleton.getInstance().getPlayer().getDexterity();
			...
			str = PlayerSingleton.getInstance().getPlayer().getDexterityExtra() >= 0 ? " + "
					: " ";
			str = str
					+ PlayerSingleton.getInstance().getPlayer()
							.getDexterityExtra();
			Text dexterityPlus = TextFactory.createText(str,
					texture.getmFont3());
			if (PlayerSingleton.getInstance().getPlayer().getDexterityExtra() >= 0) {
			...
			str = PlayerSingleton.getInstance().getPlayer()
					.getIntelligenceExtra() >= 0 ? " + " : " ";
			str = str
					+ PlayerSingleton.getInstance().getPlayer()
							.getIntelligenceExtra();
			Text IntelligencePlus = TextFactory.createText(str,
					texture.getmFont3());
			if (PlayerSingleton.getInstance().getPlayer()
					.getIntelligenceExtra() >= 0) {
