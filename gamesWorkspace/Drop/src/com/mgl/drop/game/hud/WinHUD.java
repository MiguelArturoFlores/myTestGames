...
public class WinHUD extends HUD {
	...
	public WinHUD(Scene scene, LevelController levelController, Level level,int stars) {
		try {
			...
			SelectNextLevelButton selectNextLevelButton = new SelectNextLevelButton(
					camera.getWidth() - 40, 220,
					texture.getTextureByName("selectNext.png"),
					texture.getVertexBufferObjectManager(), levelController, level);
			selectNextLevelButton.setSize(50, 50);
			selectNextLevelButton.setPosition(camera.getWidth()/2 - selectLevelButton.getWidth() / 2 +100, camera.getHeight()/2 - text.getHeight() / 2 + 50 + offset);
			...
			star1.setSize(50, 50);
			star1.setPosition(5+camera.getWidth()/2 -100,selectNextLevelButton.getHeight()  +20 + selectNextLevelButton.getY());
			...
			star2.setSize(50, 50);
			star2.setPosition(star1.getX()+star1.getWidth()+10,selectNextLevelButton.getHeight()  +20 + selectNextLevelButton.getY()) ;
			...
			star3.setSize(50, 50);
			star3.setPosition(star2.getX()+star2.getWidth()+10,selectNextLevelButton.getHeight()  +20 + selectNextLevelButton.getY()) ;
			...
			for(int i = 1; i<=stars; i++){
				...
				//star1F.setPosition(5+camera.getWidth()/2 -100,selectNextLevelButton.getHeight()  +20 + selectNextLevelButton.getY());
			}
