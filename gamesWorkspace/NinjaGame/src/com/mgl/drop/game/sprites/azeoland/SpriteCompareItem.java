...
public class SpriteCompareItem extends MySprite{
	...
	private void compare(SpriteItem item1Spr, SpriteItem item2Spr) {
		try {
			...
			Text str = TextFactory.createText("STR", texture.getmFont4());
			Text dex = TextFactory.createText("DEX", texture.getmFont4());
			Text inte = TextFactory.createText("INT", texture.getmFont4());
			...
			if(item1Spr==null || item1Spr.getItem() == null){
				item1 = new Item(-1L,null, "", "", 0, 0, 0, 0, 0, 0, 0, 0, ItemType.EAR);
			}else{
			...
			Text str1 = TextFactory.createText(""+item1.getStrength(), texture.getmFont4());
			Text dex1 = TextFactory.createText(""+item1.getDexterity(), texture.getmFont4());
			Text int1 = TextFactory.createText(""+item1.getIntelligence(), texture.getmFont4());
			
			Text str2 = TextFactory.createText(""+item2.getStrength(), texture.getmFont4());
			Text dex2 = TextFactory.createText(""+item2.getDexterity(), texture.getmFont4());
			Text int2 = TextFactory.createText(""+item2.getIntelligence(), texture.getmFont4());
