...
public class TestDatabase {
	...
	public static void main(String[] args) {
		// User user = new User("Miguel", "Flores", "miguel", "123",
		// "miguelflores2505@gmail.com");
		try {
			...
			/*
			 * Photo photo = new Photo(); photo.setPhoto(
			...
			System.out.println("cierro abcs");
			session.close();*/
			testSearchHashtag();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private static void testSearchHashtag() {

		String postText = "post #ds #fggg";
		ArrayList<String> hashtagList = new ArrayList<String>();
		boolean searching =false;
		String hasht =new String();
		for(int i =0;i<postText.length();i++){
			String s = postText.substring(i,i+1);
