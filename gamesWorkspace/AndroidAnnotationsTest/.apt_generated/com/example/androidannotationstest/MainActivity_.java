    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        buttonNext = ((Button) hasViews.findViewById(id.buttonNextActivity));
        buttonFragmentShow = ((Button) hasViews.findViewById(id.buttonFragmentShow));
        if (buttonFragmentShow!= null) {
            buttonFragmentShow.setOnClickListener(new OnClickListener() {


                @Override
                public void onClick(View view) {
                    MainActivity_.this.buttonFragmentShow();
                }
        ...
        if (buttonNext!= null) {
            buttonNext.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    MainActivity_.this.buttonNextClick();
                }
