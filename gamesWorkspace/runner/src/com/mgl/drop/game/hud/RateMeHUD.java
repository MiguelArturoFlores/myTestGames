...
public class RateMeHUD extends MyHud {
	...
	public RateMeHUD() {
		try {
			...
			SpriteBackground backgroundScreen = new SpriteBackground(0, 0,
					texture.getTextureByName("rateScreen.png"),
					texture.getVertexBufferObjectManager());
			backgroundScreen.setSize(MainDropActivity.CAMERA_WIDTH, MainDropActivity.CAMERA_HEIGHT);
			
			this.attachChild(backgroundScreen);
	...
	private void addFiveStars() {
		try {
			...
			rate1.setPosition(150,  MainDropActivity.CAMERA_HEIGHT/2 - rate1.getHeight()/2 - extra);
			...
			rate2.setPosition(rate1.getX()+rate1.getWidth()+5,  MainDropActivity.CAMERA_HEIGHT/2 - rate1.getHeight()/2 - extra);
			...
			rate3.setPosition(rate2.getX()+rate2.getWidth()+5,  MainDropActivity.CAMERA_HEIGHT/2 - rate1.getHeight()/2 - extra);
			...
			rate4.setSize(90, 90);
			rate4.setRealRate(true);
			rate4.setPosition(rate3.getX()+rate3.getWidth()+5,  MainDropActivity.CAMERA_HEIGHT/2 - rate1.getHeight()/2 - extra);
			...
			rate5.setPosition(rate4.getX()+rate4.getWidth()+5,  MainDropActivity.CAMERA_HEIGHT/2 - rate1.getHeight()/2 - extra);
