...
//			this.attachChild(fade);
	...
	private void navigate() {
		try {
			...
			ButtonNavigatePurchase navigateNext = new ButtonNavigatePurchase(MainDropActivity.CAMERA_WIDTH-60, MainDropActivity.CAMERA_HEIGHT/2 -60, texture.getTextureByName("arrowRight.png"), texture.getVertexBufferObjectManager(), spriteList, true);
			this.attachChild(navigateNext);
			this.registerTouchArea(navigateNext);
			
			ButtonNavigatePurchase navigatePrev = new ButtonNavigatePurchase(0, MainDropActivity.CAMERA_HEIGHT/2 -60, texture.getTextureByName("arrowLeft.png"), texture.getVertexBufferObjectManager(), spriteList, false);
