...
//	}
	...
	public void changePercentage(Level level) {
		SQLiteDatabase db = this.getReadableDatabase();
		try {

			String SQL = " update level set percentage = "+ level.getPercentage()+", minstar = "+level.getMinStar() +", stars = "+ level.getStars()+"  where id = "
					+ level.getId() + " ";
			// Cursor c = this.getReadableDatabase().rawQuery(SQL, null);
			db.execSQL(SQL);
	...
	public void updateFromUpgrade(PlayerDB player) {
		SQLiteDatabase db = this.getReadableDatabase();
		try {

			String SQL = " update player set stars = "+ player.getStars()+", likesQuantity = "+ player.getLikesQuantity()+" where id = "
					+ player.getId() + " ";
			// Cursor c = this.getReadableDatabase().rawQuery(SQL, null);
			db.execSQL(SQL);
	...
	public void updateDatabaseUserInfo(UserInfo u) {
		...
		try {
			...
			//SQL = SQL + " , lastDateWhatsapp= " +u.getDateWhatsapp();
			SQL = SQL + " , email= '" +u.getEmail()+"'";
			//SQL = SQL + " , lastDateFacebook= " +u.getDateFacebook();
			//SQL = SQL + " , language= " +u.getLanguage();
			SQL = SQL + " , contShareWhatsapp= " +u.getContShareWhatsapp();
			SQL = SQL + " , contShareTwitter= " +u.getContShareTwitter();
			SQL = SQL + " , contShareFacebook= " +u.getContShareFacebook();
			SQL = SQL + " , starRating= " +u.getStarRating();
