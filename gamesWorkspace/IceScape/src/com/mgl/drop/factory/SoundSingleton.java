...
public class SoundSingleton {
	...
	private SoundSingleton(SoundManager soundManager2,
		...
		try {
			...
			loadMusicByName("gameLoop.ogg");
			loadMusicByName("musicBegin.ogg");
			
			loadSoundByName("eat.mp3");
			loadSoundByName("fishAppear.mp3");
			loadSoundByName("iceCrack.mp3");
			loadSoundByName("loose.mp3");
			loadSoundByName("moveLeft.mp3");
			loadSoundByName("moveRight.mp3");
			loadSoundByName("hit.mp3");
	...
	public void playFishAppear() {
		try {
			
			playSound("fishAppear.mp3");
