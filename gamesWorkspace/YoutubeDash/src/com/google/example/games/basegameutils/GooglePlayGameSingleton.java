...
public class GooglePlayGameSingleton {
	...
	public static final String LEADERBOARD_DIVAZA = "CgkInbTf-9cbEAIQHQ";
	public static final String LEADERBOARD_VARDOC = "CgkInbTf-9cbEAIQHg";
	public static final String LEADERBOARD_OTHER = "CgkInbTf-9cbEAIQHw";
	
	public static final String LEADERBOARD_PEWPIE = "CgkInbTf-9cbEAIQIA";
	public static final String LEADERBOARD_WEREVER = "CgkInbTf-9cbEAIQIQ";
	public static final String LEADERBOARD_MARKIP = "CgkInbTf-9cbEAIQIg";
	public static final String LEADERBOARD_LUISITO = "CgkInbTf-9cbEAIQIw";
