...
public class TwitterSingleton {
	...
	public void loginToTwitter() {
		try {
			...
			twitterAuthClient.authorize(SceneManagerSingleton.getInstance().getActivity(), new com.twitter.sdk.android.core.Callback<TwitterSession>() {
                ...
                //HUDManagerSingleton.getInstance().addHUD(new InformativeHUD("success twitter"), true);
		...
		try {
			...
			message = getTwitterShareMessage(Float.valueOf(score).intValue())
					...
					+ SceneManagerSingleton.getInstance().getActivity()
							.getString(R.string.YOUTUBER_DASH_URL);
	...
	public static String getTwitterShareMessage(int score) {
		try {
			...
			message = "\""
					+ activity.getString(R.string.IHAVE_WIN)
					+ " "
					+ score
					+ " "
					+ activity.getString(R.string.POINTS_PLAYING)
					+ " "
					+ TwitterSingleton.getYoutuberTwitter(UserInfoSingleton
							.getInstance().getPlayerSelected()) + " "
					+ activity.getString(R.string.TO_YOUTUBER_DASH) + "\"";
