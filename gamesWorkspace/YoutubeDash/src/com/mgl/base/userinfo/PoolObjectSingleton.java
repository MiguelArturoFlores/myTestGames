...
public class PoolObjectSingleton {
	...
	public SpritePlayer getPlayer() {
		...
		try {
			...
			case GameConstants.PLAYER_K:
				...
				break;
			case GameConstants.PLAYER_L:

				textureName = "character12.png";
				break;
			case GameConstants.PLAYER_M:

				textureName = "character13.png";
				break;
			case GameConstants.PLAYER_N:

				textureName = "character14.png";
				break;
			case GameConstants.PLAYER_O:

				textureName = "character15.png";
				break;

			case GameConstants.PLAYER_P:

				textureName = "character16.png";
				break;
			case GameConstants.PLAYER_Q:

				textureName = "character17.png";
				break;
			default:
				textureName = "character1.png";
				break;
	...
	public String getLeaderboardName(Integer id) {
		try {
			...
			case GameConstants.PLAYER_L:
				return GooglePlayGameSingleton.LEADERBOARD_DIVAZA;

			case GameConstants.PLAYER_M:
				return GooglePlayGameSingleton.LEADERBOARD_VARDOC;

			case GameConstants.PLAYER_N:
				return GooglePlayGameSingleton.LEADERBOARD_PEWPIE;
			
			case GameConstants.PLAYER_O:
				return GooglePlayGameSingleton.LEADERBOARD_WEREVER;
			
			case GameConstants.PLAYER_P:
				return GooglePlayGameSingleton.LEADERBOARD_MARKIP;
				
			case GameConstants.PLAYER_Q:
				return GooglePlayGameSingleton.LEADERBOARD_LUISITO;
		...
		GooglePlayGameSingleton.getInstance();
		return GooglePlayGameSingleton.LEADERBOARD_GENERAL;
	}
