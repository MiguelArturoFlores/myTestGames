...
//				this.attachChild(resetButton);
		...
		private void createWinHUD() {
			...
			try {
				...
				player.setSize(170, 170);
				player.setPosition(10, MainDropActivity.CAMERA_HEIGHT/4 +10);
				
				
				SpriteStarGenerator starGenerator = (SpriteStarGenerator) MyFactory.createObstacle(SpriteTypeConstant.STAR_GENERATOR, controller);
				starGenerator.setAlpha(0);
				starGenerator.setWin(true);
				starGenerator.setR(1f);
				starGenerator.setG(1f);
				starGenerator.setB(1f);
				starGenerator.setAutoUpdate();
				...
				this.attachChild(starGenerator);
