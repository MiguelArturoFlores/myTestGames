...
public class ButtonHelp extends MySprite {


	public ButtonHelp(float pX, float pY, 
		...
		Text textMore = ObjectFactorySingleton.getInstance().createText("HELP",
				texture.getmFont1());
	...
	public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
		...
		case TouchEvent.ACTION_DOWN:
			...
			SceneManagerSingleton.getInstance().setCurrentScene(AllScenes.HELP);
