...
public class ButtonShareFacebook extends MySprite{
	...
	public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
		...
		try {
			...
			case TouchEvent.ACTION_UP:
				...
				UserInfoSingleton.getInstance().increaseMoney(25);
	...
	private void beginFacebookShare() {
		try {
			String urlToShare = SceneManagerSingleton.getInstance().getActivity().getString(com.mgl.smasher.R.string.FACEBOOK_SHARE_URL);
