...
public class TwitterSingleton {
	...
	public static String TWITTER_CONSUMER_KEY = "PgQ9CVGDUDA6iF8QFMZ0j4XQS";
	public static String TWITTER_CONSUMER_SECRET = "yvDE5cYAMsJcK4WQJd56EYpHrQ61OW6Fp2tt9BXZOqK1xfc0zk";
		...
		try {
			...
			SpriteMessage message2 = MyFactory.createMessage(
					SceneManagerSingleton.getInstance().getActivity()
							.getString(com.mgl.smasher.R.string.EARN_POWER_D) + 10, 3f);
	...
	public void postYoutuberTweet(float score) {
		try {
			...
			message = getTwitterShareMessage(Float.valueOf(score).intValue())
					+ " "
					+ SceneManagerSingleton.getInstance().getActivity()
							.getString(R.string.SMASHER_URL);
